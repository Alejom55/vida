        ...
        <div class="contenedor__todo">
            ...
            <div class="contenedor__login_register"> 
                ...
                <form action="php/login_usuario_be.php" method="POST" class="formualrio__login">
                    ...
                    <input type="text" id="login_correo" placeholder="Correo electronico" name="login_correo">
                    <input type="password" id="login_contrasena" placeholder="Contraseña" name="login_contrasena">
                ...
                <form action="php/registro_usuario_be.php" method="POST" class="formualrio__register">
                    ...
                    <input type="password" id="confirmar_contrasena" placeholder="Confirmar contraseña" name="confirmar_contrasena">
